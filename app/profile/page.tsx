        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
              ...
              <p className="text-3xl font-bold text-white font-sans">Level 1</p>
              <p className="text-gray-400 text-sm font-sans mt-2">Beginner</p>
            </div>
            ...
            <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
              ...
              <p className="text-3xl font-bold text-white font-sans">0 days</p>
              <p className="text-gray-400 text-sm font-sans mt-2">Start training to build your streak</p>
            </div>
          </div>
        </div>
